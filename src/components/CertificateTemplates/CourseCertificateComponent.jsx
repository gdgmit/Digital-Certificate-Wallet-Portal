...
const CourseCertificateComponent = ({ studentName, courseName, date, skills, scale= 1.5 }) => {
  return (
    <div className="flex items-center justify-center min-h-screen">
      <div style={{ transform: `scale(${scale})` }}>
        <div className="relative w-[368px] h-[248px] opacity-100 border border-[#1c1c1c] overflow-hidden">
