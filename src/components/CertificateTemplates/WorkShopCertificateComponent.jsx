...
const WorkShopCertificateComponent = ({ studentName, workshopName, date , scale = 1.5 }) => {
  return (
    <div className="w-full h-screen flex justify-center items-center bg-gray-100">
      <Helmet>
        <title>Workshop Certificate</title>
      </Helmet>
      <div className="w-[400px] h-[280px] flex overflow-hidden relative bg-white shadow-lg" style={{ transform: `scale(${scale})` }}>
