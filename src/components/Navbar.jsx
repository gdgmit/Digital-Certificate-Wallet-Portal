...
const Navbar = ({ isLoggedIn, setIsLoggedIn, handleLogout }) => {
  ...
  return (
    <nav className="bg-white text-blue-600 py-4">
      <div className="cw-full flex justify-between items-center relative px-4">
        {/* Hamburger Icon (3-line symbol) on the left, always visible */}
        {isLoggedIn && (
          <button
            className="block text-blue-600 bg-white mr-2"
            ...
            <ul>
              <li>
                <button
                  ...
                  className="w-full bg-white text-left hover:underline mb-4"
                >
                  My Profile
                </button>
              </li>
              <li>
                <button
                  ...
                  className="w-full bg-white text-left hover:underline"
                >
                  Log Out
                </button>
              </li>
